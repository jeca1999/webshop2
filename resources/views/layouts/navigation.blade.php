<nav x-data="{ open: false }" class="bg-black dark:bg-black border-b border-red-500">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center"> 
                    <a href="{{ url('/') }}">
                        <h1 class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200"> 3ELLLE</h1>
                    </a>
                </div>
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(!in_array(Route::currentRouteName(), $policyRoutes))
                        @if(Auth::guard('seller')->check())
                            ...
                            <x-nav-link :href="route('seller.products.manage')" :active="request()->routeIs('seller.products.manage')">
                                {{ __('Manage Products') }}
                            </x-nav-link>
